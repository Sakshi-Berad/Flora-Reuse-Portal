    ...
    <div class="container">
        <div class="row">
            <div class="col-12 bg-light p-2 shadow mt-3">
                <p class="my-2"><b>{{env("APP_NAME")}} | 24x7 Customer Care Support</b></p>
                <p class="contact-desc">The {{env("APP_NAME")}} Help Centre page lists out various types of issues that you may have
                    ...
                    can get the {{env("APP_NAME")}} Help Centre number or even access {{env("APP_NAME")}} Help Centre support if you need
