        ...
        <div class="swiper-wrapper">
            <div class="tp-slider-item-2 tp-slider-height-2 p-relative swiper-slide grey-bg-5 d-flex align-items-end">
                <div class="tp-slider-2-shape">
                    <img class="tp-slider-2-shape-1" src="assets/front/img/slider/2/shape/shape-1.png" alt="">
                </div>
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="tp-slider-content-2">
                                <span>Deep Utsav'24</span>
                                <h3 class="tp-slider-title-2 fs-1">New Festive Diwali Gifts</h3>
                                <div class="tp-slider-btn-2">
                                    <a href="/shop" class="tp-btn tp-btn-border" target="_blank">Shop Now</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="tp-slider-thumb-2-wrapper p-relative">
                                <div class="tp-slider-thumb-2-shape">
                                    <img class="tp-slider-thumb-2-shape-1"
                                        src="assets/front/img/slider/2/shape/shape-2.png" alt="">
                                    <img class="tp-slider-thumb-2-shape-2"
                                        src="assets/front/img/slider/2/shape/shape-3.png" alt="">
                                </div>
                                <div class="tp-slider-thumb-2 text-end">
                                    <span class="tp-slider-thumb-2-gradient"></span>
                                    <img src="assets/front/img/slider/2/slider-1.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="tp-slider-content-2">
                                ...
                                <h3 class="tp-slider-title-2 fs-1">Gift Collection</h3>
                                <div class="tp-slider-btn-2">
                                    <a href="/shop" class="tp-btn tp-btn-border" target="_blank">Shop Now</a>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="tp-slider-thumb-2-wrapper p-relative">
                                ...
                                <div class="tp-slider-thumb-2 text-end">
                                    <span class="tp-slider-thumb-2-gradient"></span>
                                    <img src="assets/front/img/slider/2/slider-2.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="tp-slider-content-2">
                                ...
                                <h3 class="tp-slider-title-2 fs-1">The Magic of Aromatherapy</h3>
                                <div class="tp-slider-btn-2">
                                    <a href="/shop" class="tp-btn tp-btn-border" target="_blank">Shop Now</a>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="tp-slider-thumb-2-wrapper p-relative">
                                ...
                                <div class="tp-slider-thumb-2 text-end">
                                    <span class="tp-slider-thumb-2-gradient"></span>
                                    <img src="assets/front/img/slider/2/slider-3.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            @foreach ($categories as $category)
                    ...
                    <div class="tp-banner-item-2 p-relative z-index-1 grey-bg-2 mb-20 fix">
                        <div class="tp-banner-thumb-2 include-bg transition-3"
                            data-background="/uploads/category/thumb/{{$category->image}}"></div>
                        <h3 class="tp-banner-title-2 ">
                            <?php $type = $category->type =="manufactured" ? "shop":"raw-material";?>
                            <a href="{{$type}}/{{$category->slug}}">{{$category->name}}</a>
                        </h3>
                        <div class="tp-banner-btn-2">
                            <a href="{{$type}}/{{$category->slug}}" class="tp-btn tp-btn-border tp-btn-border-sm" target="_blank">Shop Now
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="tp-section-title-wrapper-2 text-center mb-50">
                    ...
                    <h3 class="tp-section-title-2">New Arrivels.</h3>
                </div>
            </div>
        </div>
        <div class="row">
                                                                                ...
                                                                                <div class="tp-category-content-2">
                                                                                    ...
                                                                                    <div class="tp-category-btn-2">
                                                                                        <a href="javascript:void(0)" onclick="addToCart({{ $product->id }})"
                                                                                            class="tp-btn tp-btn-border"> Add to
                                                                                            Cart</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                                ...
                                                                                <div class="tp-product-item-2 mb-40">
                                                                                    <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                                                        {{-- <a href="product-details.html">
                                                                                            <img src="assets/front/img/product/2/prodcut-1.jpg" alt="">
                                                                                        </a> --}}
                                                                                        <a href="{{ route("front.product", $product->slug) }}" class="product-img">

                                                                                            {{-- <img class="card-img-top"
                                                                                                src="{{ asset('front-assets/images/product-1.jpg')}}" alt=""> --}}
                                                                                            @if (!empty($productImage->image))
                                                                                                <img src="{{ asset('/uploads/products/small/' . $productImage->image) }}"
                                                                                                    alt="error" class="card-img-top">
                                                                                            @else
                                                                                        ...
                                                                                        <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                                                            <div class="tp-product-action-item-2 d-flex flex-column">
                                                                                                @if ($product->track_qty == 'Yes')
                                                                                                    @if ($product->qty > 0)
                                                                                                        <a type="button" class="tp-product-action-btn-2 tp-product-add-cart-btn"
                                                                                                ...
                                                                                                <a type="button"
                                                                                                    class="tp-product-action-btn-2 tp-product-add-to-wishlist-btn whishlist"
                                                                                    ...
                                                                                    <div class="tp-product-content-2 pt-15">
                                                                                        ...
                                                                                        <h3 class="tp-product-tag-2 tp-product-title-2">
                                                                                            <a
                                                                                        ...
                                                                                        <div class="tp-product-price-wrapper-2">
                                                                                            ...
                                                                                            <span
                                                                                                class="tp-product-price-2 old-price">₹.{{ $product->compare_price }}</span>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
...
<section class="tp-testimonial-area grey-bg-7 pt-130 pb-135 d-none">
    <div class="container">
                                ...
                                <div class="swiper-wrapper">
                                        ...
                                        <div
                                            ...
                                            <div class="tp-testimonial-user d-flex align-items-center">
                                                <div class="tp-testimonial-avater mr-10">
                                                    <img src="assets/front/img/users/user-2.jpg" alt="">
                                                </div>
                                    ...
                                    <div class="tp-testimonial-item text-center mb-20 swiper-slide">
                                        ...
                                        <div
                                            ...
                                            <div class="tp-testimonial-user d-flex align-items-center">
                                                <div class="tp-testimonial-avater mr-10">
                                                    <img src="assets/front/img/users/user-3.jpg" alt="">
                                                </div>
                                                <div class="tp-testimonial-user-info tp-testimonial-user-translate">
                                    ...
                                    <div class="tp-testimonial-item text-center mb-20 swiper-slide">
                                        ...
                                        <div
                                            ...
                                            <div class="tp-testimonial-user d-flex align-items-center">
                                                <div class="tp-testimonial-avater mr-10">
                                                    <img src="assets/front/img/users/user-4.jpg" alt="">
                                                </div>
                                                <div class="tp-testimonial-user-info tp-testimonial-user-translate">
        ...
        <div class="row row-cols-lg-5 row-cols-sm-2 row-cols-1 gx-2 gy-2 gy-lg-0">
            <div class="col">
                <div class="tp-instagram-item-2 w-img">
                    <img src="assets/front/img/instagram/2/insta-1.jpg" alt="">
                    <div class="tp-instagram-icon-2">
                        <a href="assets/front/img/instagram/2/insta-1.jpg" class="popup-image"><i
            ...
            <div class="col">
                <div class="tp-instagram-item-2 w-img">
                    <img src="assets/front/img/instagram/2/insta-2.jpg" alt="">
                    <div class="tp-instagram-icon-2">
                        <a href="assets/front/img/instagram/2/insta-2.jpg" class="popup-image"><i
                                class="fa-brands fa-instagram"></i></a>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="tp-instagram-banner text-center">
                    <div class="tp-instagram-banner-icon mb-40">
                        <a href="#">
                            <img src="assets/front/img/instagram/2/insta-icon.png" alt="">
                        </a>
                    </div>
            ...
            <div class="col">
                <div class="tp-instagram-item-2 w-img">
                    <img src="assets/front/img/instagram/2/insta-3.jpg" alt="">
                    <div class="tp-instagram-icon-2">
                        <a href="assets/front/img/instagram/2/insta-3.jpg" class="popup-image"><i
                                class="fa-brands fa-instagram"></i></a>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="tp-instagram-item-2 w-img">
                    <img src="assets/front/img/instagram/2/insta-4.jpg" alt="">
                    <div class="tp-instagram-icon-2">
                        <a href="assets/front/img/instagram/2/insta-4.jpg" class="popup-image"><i
                                class="fa-brands fa-instagram"></i></a>
                    </div>
                </div>
            </div>
