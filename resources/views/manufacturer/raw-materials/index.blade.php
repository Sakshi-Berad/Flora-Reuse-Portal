    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{route('manufacturer.raw-materials.create')}}" class="btn btn-primary">New Product</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
                ...
                <div class="card-header">
                    <div class="card-title">
                        <button type="button" class="btn btn-default btn-sm"
                            onclick="window.location.href='{{route('manufacturer.raw-materials.index')}}'">Reset</button>
                    </div>
                        ...
                        @if ($products->isNotEmpty())
                                            ...
                                            @foreach ($products as $product)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="{{ route('manufacturer.raw-materials.edit', $product->id) }}">
...
<script>
    function deleteProduct(id) {
        var url = '{{ route("manufacturer.raw-materials.destroy", "ID") }}';
        ...
        if (confirm('Are you sure you want to delete this category')) {
            $.ajax({
                ...
                success: function (response) {
                    if (response["status"]) {
                        window.location.href = "{{route('manufacturer.raw-materials.index')}}";
                    }
                    else {
                        window.location.href = "{{route('manufacturer.raw-materials.index')}}";
                    }
