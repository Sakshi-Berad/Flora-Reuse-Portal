...
@section('content')
        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{route('manufacturer.raw-materials.index')}}" class="btn btn-primary">Back</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="{{route('manufacturer.raw-materials.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-8">
                        <div class="card mb-3">
                ...
                <div class="pb-5 pt-3">
                    ...
                    <a href="{{route('manufacturer.raw-materials.index')}}" class="btn btn-outline-dark ml-3">Cancel</a>
                </div>
            </form>
        </div>
        <!-- /.card -->
...
@section('customJs')
    <script>
        ...
        $("#category").change(function() {
            ...
            $.ajax({
                url: '{{ route('manufacturer-subcategories.index') }}',
                type: 'get',
                data: {
