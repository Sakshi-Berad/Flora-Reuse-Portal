        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('manufacturer.orders.index') }}" class="btn btn-primary">Back</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
...
@section('customJs')
    <script>
        ...
        $('#changeOrderStatusForm').submit(function(event){
            ...
            {
            $.ajax({
                url: '{{ route("manufacturer.orders.changeOrderStatus",$order->id) }}',
                type: 'post',
                data: $(this).serializeArray(),
                dataType: 'json',
                success: function(response){
                    window.location.href='{{route("manufacturer.orders.detail",$order->id) }}';
                }
            });
        }
        });
        ...
        $('#sendInvoiceEmail').submit(function(event){
            ...
            $.ajax({
                url: '{{ route("manufacturer.orders.sendInvoiceEmail",$order->id) }}',
                type: 'post',
                data: $(this).serializeArray(),
                dataType: 'json',
                success: function(response){
