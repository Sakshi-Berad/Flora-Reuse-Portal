    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{route('manufacturer.coupons.create')}}" class="btn btn-primary">New Discount Coupons</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="card-title">
                    <button type="button" class="btn btn-default btn-sm" onclick="window.location.href='{{route("manufacturer.coupons.index")}}'">Reset</button>
                </div>
                    ...
                    <tbody>
                        @if ($discountCoupons->isNotEmpty())
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('manufacturer.coupons.edit',$discountCoupon->id)}}">
...
<script>
    ...
    {
        var url = '{{ route("manufacturer.coupons.delete","ID") }}';
        var newUrl = url.replace("ID",id);
            ...
            if(confirm('Are you sure you want to delete this discount coupon'))
            {
                ...
                success: function(response)
                {
                    if(response["status"])
                    {
                        window.location.href="{{route('manufacturer.coupons.index')}}";
                    }
                }
            });
            }
