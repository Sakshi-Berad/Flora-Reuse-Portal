        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('manufacturer.coupons.index') }}" class="btn btn-primary">Back</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <form action="" method="post" id="discountForm" name="discountForm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" placeholder="Description here" name="description" id="description" cols="30" rows="5"></textarea>
                                <p></p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="pb-5 pt-3">
                    ...
                    <a href="{{ route('manufacturer.coupons.index') }}" class="btn btn-outline-dark ml-3">Cancel</a>
                </div>
            </form>
        </div>
        <!-- /.card -->
...
@section('customJs')
    <script>
        ...
        $("#discountForm").submit(function(event)
        {
            ...
            $.ajax({
                url: '{{route("manufacturer.coupons.store")}}',
                type: 'post',
