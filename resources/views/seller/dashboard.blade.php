        ...
        <div class="row">
            <div class="col-lg-4 col-6">
                <div class="small-box card">
                    ...
                    <a href="{{ route('seller.orders.index') }}" class="small-box-footer text-dark">More info <i
            ...
            <div class="col-lg-4 col-6">
                <div class="small-box card">
                    ...
                    <a href="{{ route('seller.raw-materials.index') }}" class="small-box-footer text-dark">More info <i
                            class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            {{--<div class="col-lg-4 col-6">
