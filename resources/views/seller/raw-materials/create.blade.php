...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="{{route('seller.raw-materials.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-8">
                        <div class="card mb-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror"
                                                placeholder="Title" onkeyup="Slug()" required>
                                            @error('title')
                                        ...
                                        <div class="mb-3">
                                            <label for="slug">Self Life</label>
                                            <input type="number" min="1" max="5" name="self_life" id="self_life" class="form-control @error('self_life') is-invalid @enderror"
