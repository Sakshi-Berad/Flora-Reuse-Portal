...
@section('content')
        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('seller.raw-materials.index') }}" class="btn btn-primary">Back</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="{{ route('seller.raw-materials.update',$product->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-8">
                        <div class="card mb-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title" id="title" class="form-control"
                                                placeholder="Title" onkeyup="Slug()" value="{{ $product->title }}">
                                            <p class="error"></p>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <?php $d=json_decode($product->metadata);?>
                                            <label for="self_life">Self Life</label>
                                            <input type="number"  min="1" max="5" name="self_life" id="self_life" class="form-control"
                                                placeholder="Self Life" value="{{ $d->self_life??0 }}">
                                            <p class="error"></p>
                            ...
                            <div class="row" id="product-gallery">
                                @if ($productImages->isNotEmpty())
                                    @foreach ($productImages as $image)
                                        <div class="col-md-6" id="image-row-{{ $image->id }}">
                ...
                <div class="pb-5 pt-3">
                    ...
                    <a href="{{ route('seller.raw-materials.index') }}" class="btn btn-outline-dark ml-3">Cancel</a>
                </div>
            </form>
        </div>
        <!-- /.card -->
...
@section('customJs')
    <script>
        ...
        $('.related-product').select2({
            ajax: {
                url: '{{ route("seller.raw-materials.getProducts") }}',
                dataType: 'json',
                tags: true,
                multiple: true,
        ...
        $("#category").change(function() {
            ...
            $.ajax({
                url: '{{ route('seller-subcategories.index') }}',
                type: 'get',
                data: {
        ...
        function deleteImage(id) {
            ...
            if (confirm("Are you sure you want to delete image")) {
                $.ajax({
                    url: '{{ route('seller-products-image.destroy') }}',
                    type: 'delete',
                    data: {
                        id: id
                    },
