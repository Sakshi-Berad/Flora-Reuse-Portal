		...
		<div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
			<div class="col-lg-4 logo">
				<a href="{{ route('front.home') }}" class="text-decoration-none">
					...
					<span class="h2 text-uppercase text-dark bg-primary border-5 ml-n1">Fast Tech</span>
				</a>
			</div>
	...
	<div class="container">
		<nav class="navbar navbar-expand-xl" id="navbar">
			<a href="{{route('front.home')}}" class="text-decoration-none mobile-logo">
				<span class="h2 text-uppercase text-white bg-dark">FASTECH</span>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="footer-card">
					<h3>Get In Touch</h3>
					<p>JNEC, Ch. Sambhaji Nagar, Maharashtra 431001. </p> 
			...
			<div class="col-md-3 maps">
				<h5>Shop Location</h5>
				<div id="map">
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3752.132054858618!2d75.34096587367864!3d19.876645026353415!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bdba3277e7996d9%3A0x9fcc43024e019d17!2sFast%20Tech%20Technology%20(Laptop%20Multi%20Brand%20Showroom)!5e0!3m2!1sen!2sin!4v1697866851658!5m2!1sen!2sin" width="300" height="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
				</div>
			</div>			
		</div>
	</div>
			...
			<div class="row">
				<div class="col-12 mt-3">
					<div class="copy-right text-center">
						...
						<p class="text-size">All Rights Reserved. © 2024 <strong> <?= env("APP_NAME");?> </strong> Design By : <Strong>Vaibhav</Strong></p>
					</div>
				</div>
			</div>
		</div>
