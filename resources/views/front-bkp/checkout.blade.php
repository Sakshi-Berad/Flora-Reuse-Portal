...
@section('content')
    ...
    <section class="section-5 pt-3 pb-3 mb-3 bg-white blur">
        <div class="container">
    ...
    <div class="loder-gb d-none" id="loaderDiv">
        <span class="loader"></span>
    </div>

    <section class="section-9 pt-4 blur">
        <div class="container">
            <form id="orderFrom" name="orderFrom" action="" method="post">
                <div class="row">
                    <div class="col-md-8">
                        <div class="sub-title">
                    ...
                    <div class="col-md-4">
                        ...
                        <div id="discount-responce-wrapper">
                            @if (Session::has('code'))
                                <div class="mt-4" id="discount-responce">
                        ...
                        <div class="card payment-form ">
                            ...
                            <div class="pt-4">
                                <button type="submit" id="subButton" class="btn-dark btn btn-block w-100">Buy Now</button>
                                <button type="button" id="loadButton" class="btn-dark btn btn-block w-100 d-none"><i class="fa fa-spinner fa-spin"></i> Loading</button>
                            </div>
                        </div>
...
@section('customJs')
    <script>
        ...
        $("#orderFrom").submit(function(event) {
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    if(response.status == true)
                    {
                        ...
                        $("#discount-responce-wrapper").html(response.discountString);
                    }
                    else
                    {
                        $("#discount-responce-wrapper").html("<span class='text-danger'>"+response.message+"</span>");
