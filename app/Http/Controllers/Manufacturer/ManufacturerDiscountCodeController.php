...
class ManufacturerDiscountCodeController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('manufacturer.coupon.list',$data);

    }
    public function create()
    {
        return view('manufacturer.coupon.create');
    }
    ...
    public function edit(Request $request , $id)
    {
        ...
        if($coupon == null )
        {
            ...
            return redirect()->route('manufacturer.coupons.index');
        }

        $data['coupon'] = $coupon; 
        return view('manufacturer.coupon.edit',$data);
