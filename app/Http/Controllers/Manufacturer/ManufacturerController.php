...
class ManufacturerController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('manufacturer.raw-materials.index', compact('products'));
    }
    ...
    public function create()
    {
        ...
        return view('manufacturer.raw-materials.create', compact('categories', 'brands'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $product->type = "manufactured_material";
        $product->save();
        ...
        return redirect()->route('manufacturer.raw-materials.index');
    }
    ...
    public function edit($id, Request $request)
    {
        ...
        if (empty($product)) {
            ...
            return redirect()->route('manufacturer.raw-materials.index')->with('error', 'Product not found');
        }
        ...
        return view('manufacturer.raw-materials.edit', compact('categories'), compact('brands'))
