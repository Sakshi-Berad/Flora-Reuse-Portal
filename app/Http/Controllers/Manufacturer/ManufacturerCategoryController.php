...
class ManufacturerCategoryController extends Controller
{
    public function index(Request $request)
    {
        ...
        // dd($categories);
        return view('manufacturer.category.list',compact('categories'));
    }//end index()
    
    public function create()
    {
        return view('manufacturer.category.create');
    ...
    public function edit($id, Request $request)
    {
        ...
        return view('manufacturer.category.edit',compact('category'));
