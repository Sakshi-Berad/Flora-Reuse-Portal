...
class SellerCategoryController extends Controller
{
    ...
    {
        $categories = Category::where("seller_id",auth()->user()->id)->latest();
        ...
        // dd($categories);
        return view('seller.category.list',compact('categories'));
    }//end index()
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'category_image' => 'file|mimes:jpeg,jpg,png,pdf|max:2048', // Adjust validation rules as needed
        ]);
    ...
    public function update($id, Request $request)
    {
        ...
        $request->validate([
            ...
            'category_image' => 'file|mimes:jpeg,png,jpg,pdf|max:2048', // Adjust validation rules as needed
        ]);
