...
class SellerSubCategoryController extends Controller
{
    public function index(Request $request)
    {
        ...
        // dd($categories);
        return view('seller.sub_category.list',compact('subCategories'));
    }
    public function create()
    {
        $categories = Category::where("seller_id",auth()->user()->id)->orderBy('name','ASC')->get();
        return view('seller.sub_category.create',compact('categories'));
    }
    ...
    public function edit($id, Request $request)
    {
        ...
        return view('seller.sub_category.edit',compact('categories'),compact('subcategory'));
    }
